const config = {
  ...
  cloudinary: {
    cloudName: process.env.CAPSTONE_APP_CLOUDINARY_CLOUD_NAME,
    apiKey: process.env.CAPSTONE_APP_CLOUDINARY_API_KEY,
    apiSecret: process.env.CAPSTONE_APP_CLOUDINARY_API_SECRET
  }
};
